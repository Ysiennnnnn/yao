...
def main():
    # 读取数据
    a_data = read_json('/root/yao/retrieval/eval_data_use/popqa_longtail.json')  
    ...
    # 保存结果到c.json
    with open('/root/yao/retrieval/index_build_save/popqa_longtail_index.json', 'w', encoding='utf-8') as outfile:  # 替换为实际路径
